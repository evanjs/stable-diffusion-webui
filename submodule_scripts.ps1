...
New-Item -Force -Type SymbolicLink -Target ../../scripts/wildcards.py -Path ./extensions/wildcards/wildcards.py

New-Item -Type Junction -Target $PWD/wildcards -Path scripts/wildcards -ErrorAction SilentlyContinue

New-Item -Type Junction -Target $PWD/wildcards -Path extensions/wildcards/wildcards -ErrorAction SilentlyContinue
...
Copy-Item -Recurse -Force -Path $PWD/../../external/stable-diffusion/wildcards/* -Destination wildcards/
...
Get-ChildItem -File ./wildcards -Recurse |
